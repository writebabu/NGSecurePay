            ...
            <div class="accountInfo">
                <fieldset class="login">
                    ...
                    <p>
                        ...
                        <asp:Label ID="CaptchaCodeValue" runat="server" CssClass="captchaCode"></asp:Label>
                    </p>
                    <p>
                        ...
                        <asp:RequiredFieldValidator ID="CaptchaRequired" runat="server" ControlToValidate="UserEntry" 
                             CssClass="failureNotification" ErrorMessage="Catptcha Code is required." ToolTip="Catptcha Code is required." 
                             ValidationGroup="LoginUserValidationGroup">*</asp:RequiredFieldValidator>
                    </p>
                    <p>
